    ...
    <body id="kt_body" class="auth-bg bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
                ...
                <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
                    ...
                    <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                            <!--begin::Form-->
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="../../demo8/dist/authentication/layouts/creative/sign-in.html" action="#">
                                @csrf
                                <!--begin::Heading-->
                                ...
                                <a href="../../demo8/dist/authentication/layouts/creative/sign-in.html" class="link-primary fw-semibold">Sign in</a></div>
                                <!--end::Sign up-->
                            </form>
                            <!--end::Form-->
                        </div>
        ...
        <script><script>
          $('.form').on('submit',function(e){
            var formData = $(this).find('button[type = submit]')
            $.ajax({

                url: '{{ route('signup') }}', // API URL'sini buraya girin
                type: 'POST', // Veri gönderme metodu
